# Based on vanilla example script: https://github.com/esheldon/ngmix/blob/46f5a493a904f8202284ce40ede9def1875b1a1d/examples/metacal/metacal.py
"""
...
def get_args():
    ...
    parser.add_argument('--fixnoise', type=bool, default=True,
                        help='Add noise compensation.')
